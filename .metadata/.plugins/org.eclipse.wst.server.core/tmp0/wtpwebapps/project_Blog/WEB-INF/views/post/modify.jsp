...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <main class="mt-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="modifyForm" enctype="multipart/form-data" method="post" action="/post/update">
                            ...
                            <div class="mt-2">
                                ...
                                <c:if test="${ not empty post.imageUrl }">
                                    <img class="img-fluid mb-2" id="image" src="${ post.imageUrl }" alt="첨부 이미지" />
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="removeImage" name="removeImage">
                                        <label class="form-check-label" for="removeImage">이미지 삭제</label>
                                    </div>
                                </c:if>
                            ...
                            <div class="mt-2 d-none">
                                ...
                                <input class="form-control" id="author" name="author" type="text" value="${ post.author }" readonly /> <!-- readonly : 읽기 전용(편집 불가) -->
                            </div>
                        </form>
                    </div>
        ...
        <c:url value="/static/js/post_modify.js" var="postModifyJS"/> <!-- c:url을 이용하는 이유: 앞에 contextpath까지 붙여서 안전한 주소를 만들어주니까 -->
