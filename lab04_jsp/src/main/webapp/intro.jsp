...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" trimDirectiveWhitespaces="true"%> <%-- trimDirectiveWhitespaces="true": 브라우저 콘솔에 보면 jsp 태그들이 있는 곳이 빈 줄로 자리 차지하기 때문에 이를 없애기 위해서 --%>
   
<%-- page 지시문(directive)의 trimDirectiveWhitespaces속성:
    jsp 파일이 java 코드로 변환되는 과정에서 JSP 태그들이 HTML의 빈 줄로 대체되는데,
    불필요한 빈 줄들을 삭제(true)할 것인지, 아닌지(false: 기본값)를 설정하는 속성.
--%>
...
3. JSP의 구성 요소(문법 & 태그)
    ...
    (5) 식, 표현식(expression): <%= ... %>
        jsp가 java 코드로 변환될 때, out.print()메서드의 아규먼트로 전달되는 값. (끝에 세미콜론 들어가면 안됨)
        HTML 코드에 문자열을 삽입.
--%>
...
<%
/* scriptelt */
printLog("intro.jsp 실행..."); //브라우저가 아닌 이클립스 콘솔에 출력.
%>
...
<html>
	...
	<body>
        ...
        <main>
            ...
            <% //scriptlet : 메서드 안(private, public, static 등등 불가..)
